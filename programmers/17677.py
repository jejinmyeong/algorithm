...
def solution(str1, str2):
	...
	for w in range(len(str1)-1):
		temp = str1[w]+str1[w+1]
		if temp.isalpha() == True:
			s1.append(temp.lower())

	for w in range(len(str2)-1):
		temp = str2[w]+str2[w+1]
		if temp.isalpha() == True:
			s2.append(temp.lower())
	...
	answer = math.trunc((len(insep) / len(union))*65536)if len(union) != 0 else 1*65536
	return answer
